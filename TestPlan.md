...
See `RequirementTraceabilityMatrix.csv` or table below.

Exit Criteria
* 100% Pass rate on High Priority Unit Tests.
...
| **RailwayTicketing.App**  | 33.59%        | 41.11%       | 82.14%       |
...
* **Target:** `PricingService.cs` (The core complexity engine).
...
* **Target:** `UserService` + Repository.
* **Scenario:** Verify "Modify Reservation" workflow:
    1. Create Booking (OneWay)
    2. Save to list
    3. Modify (Return)
